...
use Codewithkyrian\Transformers\Models\Auto\AutoModelForTextToAudio;
...
enum Task: string
{
    ...
    public function autoModel(
        ...
        return match ($this) {
            ...
            self::TextToAudio,
            self::TextToSpeech => AutoModelForTextToAudio::fromPretrained($modelNameOrPath, $quantized, $config, $cacheDir, $revision, $modelFilename, $onProgress),
            self::ASR,
