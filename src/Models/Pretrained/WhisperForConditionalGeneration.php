...
class WhisperForConditionalGeneration extends WhisperPretrainedModel
{
    ...
    public function generate(
        ...
        if (isset($generationConfig['return_token_timestamps'], $generationConfig['alignment_heads'])) {
     ...
     * @param null|int $numFrames Number of frames in the input audio
    ...
    {
        if (0 === $windowSize % 2 || $windowSize <= 0) {
